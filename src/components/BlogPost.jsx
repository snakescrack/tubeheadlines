...
export default function BlogPost() {
  ...
  return (
    <>
      <SEO 
        title="Why I Built TubeHeadlines - The Story Behind the Platform"
        description="I built TubeHeadlines to fix YouTube discovery. Learn why manual curation and a focus on quality over algorithms makes for a better viewing experience."
