...
export default function BlogPost() {
  const pageTitle = 'Why I Built TubeHeadlines: A Better Way to Discover Great YouTube Videos';
  const pageDescription = 'Tired of the YouTube algorithm? Discover how TubeHeadlines offers a manually curated selection of high-quality videos from emerging creators, providing a better way to find content you\'ll love.';
    ...
    <>
      ...
      <div style={{maxWidth: '800px', margin: '2rem auto', padding: '2rem', fontFamily: 'Arial, sans-serif', color: '#333'}}>
        ...
        <div style={{fontSize: '1.1rem', lineHeight: '1.7'}}>
          ...
          <p>If you're a creator working hard to make amazing videos, TubeHeadlines is for you, too. We want to help you find your audience. We don't host your videos or put ads on them; every click goes directly to your YouTube channel, helping you grow.</p>
