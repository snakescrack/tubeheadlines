...
export default function Stats() {
  ...
  return (
    <div className="stats" style={{ textAlign: 'right', fontFamily: 'monospace', fontSize: '12px', marginBottom: '20px', marginRight: '10px' }}>
      ...
      <div style={{ marginTop: '8px' }}>EMAIL: info@tubeheadlines.com</div>
    </div>
  );
}
